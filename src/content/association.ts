...
export const association = {
  ...
  contact: {
     ...
     * 고유번호 (사업자등록번호 아님).
     *
     * 가운데 두 자리 82 는 비영리법인에 부여되는 코드입니다. 협회는 과세
     * 사업을 하지 않아 세무서에서 사업자등록증이 아니라 고유번호증을 받았고,
     * 그래서 푸터 표기도 "고유번호" 입니다. 나중에 수익사업을 시작해
     * 사업자등록증을 따로 받으면 그때 표기를 바꿔야 합니다.
     */
    registrationNumber: "830-82-00824",
  },
